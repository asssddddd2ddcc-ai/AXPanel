...
/* Shinobi-inspired landing skin */
body{background:radial-gradient(circle at 12% 10%,rgba(249,115,22,.20),transparent 28%),radial-gradient(circle at 88% 85%,rgba(220,38,38,.15),transparent 28%),#070708!important}
body:before{content:"";position:fixed;inset:0;pointer-events:none;background:repeating-linear-gradient(135deg,transparent 0 44px,rgba(249,115,22,.018) 45px 46px)}
.card{border-color:rgba(249,115,22,.18)!important;box-shadow:0 30px 90px rgba(0,0,0,.55),0 0 45px rgba(249,115,22,.06)!important}
.logo{background:linear-gradient(135deg,#dc2626,#f97316)!important;box-shadow:0 0 25px rgba(249,115,22,.25)}
.version,.support{color:#fb923c!important}.primary{background:linear-gradient(135deg,#dc2626,#f97316)!important}.path{color:#fdba74!important;border-color:rgba(249,115,22,.15)!important}
</style>
</head>
...
.hidden{display:none}
/* Shinobi-inspired login skin */
body{background:radial-gradient(circle at 15% 10%,rgba(249,115,22,.20),transparent 30%),radial-gradient(circle at 85% 85%,rgba(220,38,38,.14),transparent 28%),#070708!important}
body:before{content:"";position:fixed;inset:0;pointer-events:none;background:repeating-linear-gradient(135deg,transparent 0 42px,rgba(249,115,22,.018) 43px 44px)}
.card{border-color:rgba(249,115,22,.18)!important;box-shadow:0 30px 90px rgba(0,0,0,.55),0 0 40px rgba(249,115,22,.07)!important}
button{background:linear-gradient(135deg,#dc2626,#f97316)!important;border-color:rgba(249,115,22,.35)!important}
</style>
</head>
<body>
<div class="card">
...
<style>
  ...
  * {{ box-shadow: none !important; }}
  ...
  /* Shinobi-inspired info page */
  body {{ position:relative; overflow-x:hidden; }}
  body::before {{ content:""; position:fixed; inset:0; pointer-events:none; background:radial-gradient(circle at 8% 10%,rgba(249,115,22,.18),transparent 28%),radial-gradient(circle at 92% 20%,rgba(220,38,38,.14),transparent 25%),repeating-linear-gradient(135deg,transparent 0 38px,rgba(249,115,22,.018) 39px 40px); }}
  .dynamic-card {{ border-color:rgba(249,115,22,.16)!important; box-shadow:0 18px 50px rgba(0,0,0,.28)!important; }}
  .dynamic-card:hover {{ border-color:rgba(249,115,22,.34)!important; }}
  .text-purple-300 {{ color:#fb923c!important; }}
  .text-blue-300 {{ color:#f97316!important; }}
  .text-amber-300 {{ color:#fbbf24!important; }}
  .bg-blue-400\/20 {{ background:rgba(249,115,22,.12)!important; }}
  .bg-blue-400\/10 {{ background:rgba(249,115,22,.09)!important; }}
  .copy-btn:hover {{ border-color:rgba(249,115,22,.38)!important; color:#fff!important; }}
</style>
</head>
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover">
<title>Shinobi Subscription | PX Panel</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Vazirmatn:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
<style>
*{box-sizing:border-box}html,body{margin:0;min-height:100%;font-family:Vazirmatn,sans-serif}body{min-height:100vh;display:grid;place-items:center;padding:20px;color:#fff;background:#070708;overflow:hidden}
body:before{content:"";position:fixed;inset:0;background:radial-gradient(circle at 15% 15%,rgba(249,115,22,.22),transparent 30%),radial-gradient(circle at 85% 80%,rgba(220,38,38,.17),transparent 28%),repeating-linear-gradient(135deg,transparent 0 46px,rgba(255,255,255,.018) 47px 48px);pointer-events:none}
body:after{content:"";position:fixed;width:420px;height:420px;border:1px solid rgba(249,115,22,.10);border-radius:50%;box-shadow:0 0 0 28px rgba(249,115,22,.025),0 0 0 56px rgba(249,115,22,.015);pointer-events:none}
.card{position:relative;width:100%;max-width:590px;padding:30px;border:1px solid rgba(249,115,22,.20);border-radius:28px;background:linear-gradient(145deg,rgba(255,255,255,.075),rgba(255,255,255,.025));backdrop-filter:blur(24px);box-shadow:0 30px 100px rgba(0,0,0,.58),0 0 55px rgba(249,115,22,.08);overflow:hidden}
.card:before{content:"";position:absolute;top:0;right:0;width:150px;height:4px;background:linear-gradient(90deg,transparent,#dc2626,#f97316)}
.head{display:flex;align-items:center;gap:14px}.symbol{width:56px;height:56px;border-radius:18px;display:grid;place-items:center;font-size:27px;font-weight:900;color:#fff;background:linear-gradient(145deg,#dc2626,#f97316);box-shadow:0 0 26px rgba(249,115,22,.25)}
h1{margin:0;font-size:23px;font-weight:900}.sub{margin-top:3px;color:#fb923c;font-size:11px;font-weight:800;letter-spacing:.08em}.tag{margin-top:22px;display:inline-flex;align-items:center;gap:7px;padding:7px 11px;border:1px solid rgba(34,197,94,.22);border-radius:999px;background:rgba(34,197,94,.07);color:#86efac;font-size:10px;font-weight:800}.tag i{width:7px;height:7px;border-radius:50%;background:#22c55e;box-shadow:0 0 12px #22c55e}.desc{margin-top:16px;color:rgba(255,255,255,.60);font-size:13px;line-height:2}.url-wrap{margin-top:18px;padding:4px;border-radius:18px;background:linear-gradient(135deg,rgba(249,115,22,.22),rgba(220,38,38,.10))}.url{padding:15px;border-radius:15px;background:#0b0b0f;border:1px solid rgba(255,255,255,.06);direction:ltr;text-align:left;word-break:break-all;color:#fdba74;font:12px/1.9 Consolas,monospace}.actions{display:flex;gap:10px;margin-top:14px}.btn{flex:1;padding:12px;border-radius:13px;text-align:center;text-decoration:none;font-size:12px;font-weight:800}.primary{color:#fff;background:linear-gradient(135deg,#dc2626,#f97316)}.secondary{color:#fed7aa;background:rgba(249,115,22,.07);border:1px solid rgba(249,115,22,.20)}.hint{margin-top:18px;padding:12px 14px;border-radius:14px;background:rgba(255,255,255,.025);border:1px solid rgba(255,255,255,.06);color:rgba(255,255,255,.43);font-size:10px;line-height:1.9}.footer{display:flex;justify-content:space-between;gap:10px;margin-top:18px;padding-top:15px;border-top:1px solid rgba(255,255,255,.07);font-size:10px;color:rgba(255,255,255,.35)}.footer a{color:#fb923c;text-decoration:none}@media(max-width:600px){.card{padding:22px;border-radius:22px}.actions{flex-direction:column}h1{font-size:20px}}
</style></head><body><main class="card"><div class="head"><div class="symbol">火</div><div><h1>اشتراک شینوبی</h1><div class="sub">PX PANEL · SHINOBI ACCESS</div></div></div><div class="tag"><i></i> اشتراک فعال و آماده دریافت</div><div class="desc">لینک اختصاصی اشتراک شما آماده است. این آدرس را در کلاینت موردنظر وارد کنید یا برای استفاده سریع، آن را کپی کنید.</div><div class="url-wrap"><div class="url" id="subUrl"></div></div><div class="actions"><a id="openSub" class="btn primary" href="#">باز کردن لینک ساب</a><a class="btn secondary" href="https://t.me/Pixonal" target="_blank" rel="noopener">پشتیبانی</a></div><div class="hint">نکته: لینک اشتراک را خصوصی نگه دارید و در صورت تغییر دسترسی، لینک جدید را از پنل دریافت کنید.</div><div class="footer"><span>PX Panel · Shinobi Theme</span><a href="https://t.me/Pixonal" target="_blank" rel="noopener">@Pixonal</a></div></main><script>const url=location.origin+location.pathname.replace('/p/','/sub-group/');document.getElementById('subUrl').textContent=url;document.getElementById('openSub').href=url;</script></body></html>
"""
...
:root{
  ...
  --accent:#f97316;--accent2:#fb923c;--purple:#dc2626;--green:#22c55e;--red:#ef4444;--amber:#f59e0b;
  --t1:#f8fafc;--t2:rgba(248,250,252,.72);--t3:rgba(248,250,252,.42);
  --sb:252px;--sb-c:74px;--radius:18px;--shadow:0 12px 40px rgba(0,0,0,.45);
  --input-bg:rgba(0,0,0,.4);--hover:rgba(249,115,22,.14);
  --glow:0 0 42px rgba(249,115,22,.16);--glass:blur(16px);
}
html.light{
...
/* Shinobi-inspired visual layer */
body::before{content:"";position:fixed;inset:0;pointer-events:none;z-index:-1;opacity:.6;background:radial-gradient(circle at 12% 8%,rgba(249,115,22,.16),transparent 24%),radial-gradient(circle at 88% 18%,rgba(220,38,38,.13),transparent 22%),repeating-linear-gradient(135deg,transparent 0 46px,rgba(249,115,22,.018) 47px 48px);}
body::after{content:"";position:fixed;left:18px;bottom:10px;width:110px;height:110px;border:1px solid rgba(249,115,22,.05);border-radius:50%;box-shadow:0 0 0 18px rgba(249,115,22,.018),0 0 0 36px rgba(249,115,22,.01);pointer-events:none;z-index:-1;}
.sidebar{border-left-color:rgba(249,115,22,.18)!important;background-image:linear-gradient(180deg,rgba(249,115,22,.055),transparent 38%);}
.card,.panel,.section,.stat-card,.modal,.config-card{border-color:rgba(249,115,22,.12)!important;}
